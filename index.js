...
// الرد على خيار "معلومات عن البوت"
...
🔧 **التطوير والصيانة**: تم تطوير هذا البوت بواسطة [احمد محمد ابو غرقود].
    `;
    bot.sendMessage(msg.chat.id, botInfo, { parse_mode: 'Markdown' });
});

// الرد على الرسائل الأخرى (بحث حسب الاسم أو رقم الهوية)
bot.on('message', (msg) => {
